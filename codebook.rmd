...
subject - the ID of the subject wearing the device
activity - the specific activity the subject was peforming when the measurements were recorded. There are 6 distinct activities (WALKING, WALKING_UPSTAIRS, WALKING_DOWNSTAIRS, SITTING, STANDING, LAYING).

for each subject and activity, the data will contain 66 variables representing a numeric mean or std deviation for acc and gyro movement.  They are:
